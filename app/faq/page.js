  ...
  const faqs = [
    {
      ...
      a: 'আমরা মডেড (MOD) অ্যান্ড্রয়েড অ্যাপ ও গেম সরবরাহ করি। এগুলোতে প্রিমিয়াম ফিচার আনলক করা থাকে।'
    },
    {
      q: 'ডাউনলোড করতে কী কী লাগে?',
      a: 'শুধু একটি অ্যান্ড্রয়েড ডিভাইস (৫.০+) এবং ইন্টারনেট সংযোগ। কোনো রেজিস্ট্রেশন প্রয়োজন নেই।'
    },
    {
      q: 'এগুলো কি নিরাপদ?',
      a: 'আমরা প্রতিটি অ্যাপ স্ক্যান করি এবং নিরাপদ উৎস থেকে সংগ্রহ করি। তবে আপনি নিজের দায়িত্বে ইনস্টল করবেন।'
    },
    {
      q: 'অ্যাপটি কাজ না করলে কী করব?',
      a: 'প্রথমে চেক করুন আপনার অ্যান্ড্রয়েড ভার্সন সাপোর্ট করে কি না। তারপর ইনস্টলেশন গাইড ফলো করুন।'
    },
    {
